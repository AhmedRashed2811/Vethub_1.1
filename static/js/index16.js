...
// See More Time
let moreButtons2 = document.querySelectorAll('#more2');

moreButtons2.forEach(function(button2) {
    button2?.addEventListener('click', function() {
      let container2 = button2.parentElement;
      let times2 = container2.querySelectorAll('.time');
