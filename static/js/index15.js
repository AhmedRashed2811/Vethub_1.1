...
const navItemElement = bill.closest('.nav-item'); 

bill?.addEventListener("click", () => {
  navItemElement.classList.toggle("marginRight");
...
let moreButtons2 = document.querySelectorAll('#more');

moreButtons2.forEach(function(button) {
